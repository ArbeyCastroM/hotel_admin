...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="gestion_personal.php"><i class="fas fa-user-friends"></i> Gestión de Personal </a>
                    </li>
                    <li>
            ...
            <div id="page-inner">
                    ...
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Recursos Humanos<small>-Personal</small>
                        </h1>
        ...
        //include('conexionrh.php')
                ?>
        <?php include('conexion_inventario.php'); ?>
                        ...
                        <div class="form-group">
                          ...
                          <label>seleccione el empleado</label>
                              <select name="empleado" class="form-control" required >
                                ...
                                <option value="Ana Cristina Castro Mendieta">Ana Cristina Castro Mendieta</option>
                            <option value="Juan Carlos Pedraza Mondoñedo">Juan Carlos Pedraza Mondoñedo</option>
                            <option value="Graciela del Pilar Oviedo Beltran">Graciela del Pilar Oviedo Beltran</option>
                                <?php
                          $sqlEmpleado=mysqli_query($conexion,"SELECT id_empleado,codigo,nombre,cargo FROM empleados WHERE codigo='1'");
